...
```{r}
setwd("C:/Users/Paul/Desktop/Stage/Donnee")
...
```{r}
Labo_rajout <- "UMP_Mtp"
Spectro_rajout <- "Perkin_Frontier"

Circuit <- "A"
Resolution <- 2
Unite_X <- "cm-1"
Abs_ou_Ref <- "Abs"
Labo_ou_Terrain <- "Labo"
...
colonne_date <- NA # NA si pas de date/heure
colonne_heure <- NA
colonne_temp <- NA
colonne_hygro <- NA
ligne_debut <- 5
...
if (!(Spectro_rajout %in% names(Base_De_Donnees_Spectres[[Annee]][["BGE7"]][[Labo]]))) {
  for (i in (debut_ech:fin_ech)[- except_ech]) {
    ...
    Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro_rajout]] <- list(Mesure_1 = list(Meta = data.frame(Circuit = Circuit, Nb_Rep = Nb_Rep, Type_Rep = Type_Rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = Date, Heure = Heure, Temperature = Temperature, Hygrometrie = Hygrometrie), Spectre = NA))
  }
}
```
  ...
  tryCatch(
    {
      ...
      if (i < 10) {
        ...
        Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", j + 1)]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = j + 1, Type_Rep = 1, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = Date, Heure = Heure, Temperature = Temperature, Hygrometrie = Hygrometrie)
      ...
      #     nom_actuel <- paste0(debut_fichier, i, fin_fichier)
      #   }
      #   Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", k + 5)]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = k + 5, Type_Rep = 2, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = Date, Heure = Heure, Temperature = Temperature, Hygrometrie = Hygrometrie)
...
```{r}
chemin_fichier <- "C:/Users/Paul/Desktop/Stage/Donnee/Data/Circuit A/A-BIOFORA-Orleans/INSPIR_INRAE_Orleans_PerkinElmerFrontier/INSPIR_INRAE_Orleans.xlsx"



feuille <- "Perkin Elmer Frontier"
debut <- "BGE22_"
fin <- "A"

colonne_ech <- 2
colonne_premiere_mesure <- 7
...
for (i in (debut_ech:fin_ech)[- except_ech]) {
  if (!is.na(colonne_date) && is.na(colonne_heure)) {
    tryCatch(
      ...
      Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][["Mesure_1"]][["Meta"]][["Heure"]] <- format(tableau[[colonne_heure]][[y]], format = "%H:%M:%S")
      },
      warning = function(w) {
        print(i)
      }
    ...
    tryCatch(
      {
        ...
        Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][["Mesure_1"]][["Meta"]][["Date"]] <- ifelse(is.na(colonne_date), as.Date(NA), as.Date(as.numeric(tableau[[colonne_date]][[y]]), origin = "1899-12-30"))
...
nb_rep <- 5
k <- 11 # 0 par défaut, décalage pour changer le type de répétition
typ_rep <- 4
    ...
    tryCatch(
      {
        ...
        Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (1 + l + k))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = 1, Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = format(tableau[[colonne_date]][y[1 + k]], format = "%D"), Heure = format(tableau[[colonne_date]][y[1 + k]], format = "%H:%M:%S"), Temperature = Temperature, Hygrometrie = Hygrometrie)
        ...
        for (j in (2 + k):(nb_rep + k)) {
          ...
          Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (j + l))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = (j - k), Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = format(tableau$Horodatage[y[j]], format = "%D"), Heure = format(tableau$Horodatage[y[j]], format = "%H:%M:%S"), Temperature = Temperature, Hygrometrie = Hygrometrie)
    ...
    tryCatch(
      {
        ...
        Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (1 + l + k))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = 1, Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = ifelse(is.na(colonne_date), Date, format(tableau[[colonne_date]][[y[1 + k]]], format = "%d/%m/%Y")), Heure = ifelse(is.na(colonne_heure), Heure, format(tableau[[colonne_heure]][[y[1 + k]]], format = "%H:%M:%S")), Temperature = Temperature, Hygrometrie = Hygrometrie)
        
        # Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (1 + l + k))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = 1, Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = Date, Heure = ifelse(is.na(colonne_heure), Heure, tableau[[colonne_heure]][[y[1 + k]]]), Temperature = Temperature, Hygrometrie = Hygrometrie)
        ...
        for (j in (2 + k):(nb_rep + k)) {
          ...
          Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (j + l))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = (j - k), Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = ifelse(is.na(colonne_date), Date, format(tableau[[colonne_date]][[y[1 + k]]], format = "%d/%m/%Y")), Heure = ifelse(is.na(colonne_heure), Heure, format(tableau[[colonne_heure]][[y[1 + k]]], format = "%H:%M:%S")), Temperature = Temperature, Hygrometrie = Hygrometrie)
          
          # Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (j + l))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = (j - k), Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = Date, Heure = ifelse(is.na(colonne_heure), Heure, tableau[[colonne_heure]][[y[1 + k]]]), Temperature = Temperature, Hygrometrie = Hygrometrie)
  ...
  tryCatch(
    {
      ...
      Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (1 + l + k))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = 1, Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = substr(as.character(fichier[5, ]), 12, nchar(as.character(fichier[5, ]))), Heure = substr(as.character(fichier[6, ]), 8, nchar(as.character(fichier[6, ]))), Temperature = Temperature, Hygrometrie = Hygrometrie)
      ...
      for (j in (2 + k):(nb_rep + k)) {
        ...
        Base_De_Donnees_Spectres[[Annee]][[paste0("BGE", i)]][[Labo]][[Spectro]][[paste0("Mesure_", (j + l))]][["Meta"]] <- data.frame(Circuit = Circuit, Nb_Rep = (j - k), Type_Rep = typ_rep, Resolution = Resolution, Unite_X = Unite_X, Abs_ou_Ref = Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = substr(as.character(fichier[5, ]), 12, nchar(as.character(fichier[5, ]))), Heure = substr(as.character(fichier[6, ]), 8, nchar(as.character(fichier[6, ]))), Temperature = Temperature, Hygrometrie = Hygrometrie)
...
for (i in 1:178) {
  for (j in 10:17) {
    for (k in 1) {
      for (l in 1) {
        if(Base_De_Donnees_Spectres$Annee2022[[i]][[j]][["FOSS 2500"]][[k]][[2]][[1]][[2]] - Base_De_Donnees_Spectres$Annee2022[[i]][[j]][["FOSS 2500"]][[k]][[2]][[1]][[1]] != 0.5){
          print(i)
          print(j)
        }
      }
...
for (i in 1:178) {
  for (j in 10:17) {
    for (l in 1:2) {
      for (k in 1) {
        if(Base_De_Donnees_Spectres$Annee2022[[i]][[j]][[l]][[k]][[2]][[1]][[1]] != 400){
          print(i)
          print(j)
        }
      }
...
for (i in 1:30) {
  for (j in 10:17) {
    for (k in 1) {
      for (l in 1) {
        if(Base_De_Donnees_Spectres$Annee2023[[i]][[j]][["FOSS 6500"]][[k]][[2]][[1]][[2]] - Base_De_Donnees_Spectres$Annee2023[[i]][[j]][["FOSS 6500"]][[k]][[2]][[1]][[1]] != 2){
          print(i)
          print(j)
        }
      }
...
for (i in 1:30) {
  for (j in 10:17) {
    for (k in 1:2) {
      for (l in 1:length(Base_De_Donnees_Spectres$Annee2023[[i]][[j]][[k]])) {
        if(Base_De_Donnees_Spectres$Annee2023[[i]][[j]][[k]][[l]][[2]][[1]][[1]] != 400){
          print(i)
          print(j)
          print(k)
        }
...
```{r}
for (m in 1:2) {
  for (i in 1:length(Base_De_Donnees_Spectres[[m]])) {
    for (j in 2) {
      for (k in 2:3) {
        for (l in 1:length(Base_De_Donnees_Spectres[[m]][[i]][[j]][[k]])) {
          a = Base_De_Donnees_Spectres[[m]][[i]][[j]][[k]][[l]][[1]]
          Base_De_Donnees_Spectres[[m]][[i]][[j]][[k]][[l]][[1]] = data.frame(Circuit = a$Circuit, Nb_Rep = a$Nb_Rep, Type_Rep = a$Type_Rep, Resolution = a$Resolution, Unite_X = a$Unite_X, Abs_ou_Ref = a$Abs_ou_Ref, Labo_ou_Terrain = Labo_ou_Terrain, Date = a$Date, Heure = a$Heure, Temperature = a$Temperature, Hygrometrie = a$Hygrometrie)
        }
      }
    }
  }
...
for (m in 1:2) {
  for (i in 1:length(Base_De_Donnees_Spectres[[m]])) {
    for (j in 1:length(Base_De_Donnees_Spectres[[m]][[i]]) {
...
```{r}
plot(Base_De_Donnees_Spectres$Annee2022$BGE1$IGEPP_Rennes$`BRUKER MPA`$Mesure_1$Spectre, type = 'l')
plot(Base_De_Donnees_Spectres$Annee2022$BGE1$`PEGASE_St-Gilles`$`VIAVI MicroNIRS`$Mesure_1$Spectre, type = 'l')
plot(Base_De_Donnees_Spectres$Annee2022$BGE1$`PEGASE_St-Gilles`$`IDiL FlameNIR`$Mesure_1$Spectre, type = 'l')
plot(Base_De_Donnees_Spectres$Annee2023$BGE3$IGEPP_Rennes$`BRUKER MPA`$Mesure_1$Spectre, type = 'l')
plot(Base_De_Donnees_Spectres$Annee2023$BGE3$`PEGASE_St-Gilles`$`VIAVI MicroNIRS`$Mesure_1$Spectre, type = 'l')
plot(Base_De_Donnees_Spectres$Annee2023$BGE3$`PEGASE_St-Gilles`$`IDiL FlameNIR`$Mesure_1$Spectre, type = 'l')
```
